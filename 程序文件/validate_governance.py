...
validate_governance.py v1.2

校验四类治理文件的一致性和完整性：
  1. redlines-registry.md  — 红线计数一致性（声明 vs 实际 vs 统计表，统计表按表头动态解析）
  2. interface-contracts.md — IC-03/IC-08/IC-09/IC-10 JSON Schema 必填字段完整性
...
def check_interfaces(text: str, report: Report):
    report.section("接口契约 — IC-03/IC-08/IC-09/IC-10 Schema 必填字段")

    for ic_id in ["IC-03", "IC-08", "IC-09", "IC-10"]:
        # 提取 JSON Schema 块
